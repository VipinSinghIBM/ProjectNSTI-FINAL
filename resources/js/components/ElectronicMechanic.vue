          ...
          <div class="col-md-12">
            ...
            <div class="card ">
              ...
              <div class="card-header">
                <h2 class="card-title "><strong><em>Admitted Students Details -<span class=""> Electronic Mechanic</span></em></strong></h2>
...
exportStudents() {
 ...
 closeExport() {
    ...
    loadUsers(page = 1){
        axios.post("/ElectronicMechanicAdmittedList?page="+page,this.filter).then((data)=>(this.users=data.data));
    },
...
//get table data for export  function
    loadUsersForExcelExport() {
      ...
      axios.post("/ElectronicMechanicExport",this.filter).then((data) => {
