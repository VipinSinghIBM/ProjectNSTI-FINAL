...
<div class="row mt-3">
          <div class="col-md-12">
            ...
            <div class="card ">
<h2 class="text-center mt-2"><span class="badge badge-primary">Course Wise Students List - ADIT</span></h2>
              <div class="card-header">
                <h2 class="card-title"><strong><em>Admitted Students Details - ADIT</em></strong></h2>
...
exportStudents() {
 ...
 closeExport() {
    ...
    loadUsers(page =1){
        axios.post("/aditAdmitted?page="+page,this.filter).then((data)=>(this.users=data.data));
    },
...
//get table data for export  function
    loadUsersForExcelExport() {
      ...
      axios.post("/aditAdmittedForExport",this.filter).then((data) => {
