...
<div class="row mt-3">
          <div class="col-md-12">
            ...
            <div class="card ">
              ...
              <div class="card-header">
                <h2 class="card-title "><strong><em>Admitted Students Details -<span class=""> ELCTRICIAN AND WIREMAN</span></em></strong></h2>
 ...
 <button
                    type="button"
                    class="btn btn-sm btn-primary float-right mb-3 ml-3"
                    data-toggle="modal"
...
exportStudents() {
 ...
 closeExport() {
    ...
    loadUsers(page = 1){
        axios.post("/ElectricianWiremanAdmittedList?page="+page,this.filter).then((data)=>(this.users=data.data));
    },
//get table data for export  function
    loadUsersForExcelExport() {
      this.$Progress.start();

      axios.post("/ElectricianWiremanForExport",this.filter).then((data) => {
