          ...
          <div class="col-md-12">
            ...
            <div class="card ">
              ...
              <div class="card-header">
                <h2 class="card-title"><strong><em>Admitted Students Details - ELECTRICIAN (POWER DISTRIBUTION)</em></strong></h2>
...
// this.user_candidatePhoto=user.candidatePhoto;
    ...
    loadUsers(){
        axios.get("/ElectricianPowerDistributionList").then((data)=>(this.users=data.data));
    },
