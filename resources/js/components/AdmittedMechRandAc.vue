          ...
          <div class="col-md-12">
            ...
            <div class="card ">
              ...
              <div class="card-header">
                <h2 class="card-title"><strong><em>Admitted Students Details - Mechanic Refrigeration & AC</em></strong></h2>
...
exportStudents() {
 ...
 closeExport() {
    ...
    loadUsers(page = 1){
        axios.post("/RandAcAdmitted?page="+ page,this.filter).then((data)=>(this.users=data.data));
    },
//get table data for export  function
    loadUsersForExcelExport() {
      this.$Progress.start();

      axios.post("/RandAcAdmittedForExport",this.filter).then((data) => {
