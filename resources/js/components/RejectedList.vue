...
<div class="row mt-3">
          <div class="col-md-12">
            ...
            <div class="card ">
<h2 class="text-center mt-2"><span class="badge badge-danger">Rejected Students List</span></h2>
              <div class="card-header">
                <h2 class="card-title"><strong><em>Rejected Students Details</em></strong></h2>
