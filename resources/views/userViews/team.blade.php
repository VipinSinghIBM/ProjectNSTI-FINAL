...
<head>
    ...
    <title>Team C R E A T O R S</title>
    ...
    <!-- Meet Our Team -->
       ...
       <div class="row">
            ...
            <footer class="text-center text-white mt-5" style="background-color: #f1f1f1;">
                <!-- Copyright -->
                <div class="text-center text-dark p-3 mt-5" style="background-color: rgb(255, 255, 255);">
                    {{ now()->year }} Copyright:
                  <a class="text-dark" href="#">Team <b>C R E A T O R S</b></a>
                </div>
                <!-- Copyright -->
              </footer>
    </div>
